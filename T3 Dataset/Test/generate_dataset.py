...
for filename in os.listdir(path):
    ...
    image = {"path": os.path.join("/content/drive/MyDrive/Tarea_3/T3 Dataset/Test/images/", filename),
...
df.to_csv('data_test.txt', sep='\t', index=False, header=False)
stat.to_csv('info_test.txt', sep='\t', index=False, header=True)
